...
const bulmaTargetDir = `${process.env.INIT_CWD}/lib/http/public/assets/bulma/`;
...
const clipboardTargetDir = `${process.env.INIT_CWD}/lib/http/public/assets/clipboard/`;
...
const dataTablesTargetDir = `${process.env.INIT_CWD}/lib/http/public/assets/simple-datatables/`;
