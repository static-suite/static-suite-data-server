 ...
 * @param {string} absoluteFilePath - Absolute path to the file.
 *
 * @returns {Object} Object with two properties, "raw" and "json", which contain
 ...
 *
 * @param {string} dir - Absolute path to the directory to be scanned.
 *
 * @returns {array} files - Array of file paths found inside dir.
 */
...
module.exports.getModificationDate = getModificationDate;
module.exports.getVariantName = getVariantName;
