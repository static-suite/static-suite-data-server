...
routes.get('/task/:taskId', task_1.runTask);
routes.get('/cache', cache_1.cacheIndex);
routes.get('/cache/:cacheBinId/clear', cache_1.cacheClear);
routes.get('/diff', diff_1.diffIndex);
routes.get('/diff/incremental', diff_1.diffIncremental);
routes.get('/diff/full', diff_1.diffFull);
routes.get('/diff/reset', diff_1.diffReset);
...
routes.get(['/data/*storeKeyParts', '/data'], data_1.data);
routes.get(['/index/url/*storeKeyParts', '/index/url'], indexUrl_1.indexUrl);
routes.get(['/index/uuid/:langcode/:uuid', '/index/uuid'], indexUUID_1.indexUUID);
routes.get('/subset', subset_1.subset);
