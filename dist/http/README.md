...
- [Static Suite Data Server](#static-suite-data-server)
  - [Options](#options)
  - [Options from file.](#options-from-file)
  - [Usage](#usage)
    - [SSG develop/build phase](#ssg-developbuild-phase)
    - [Previewing a content from Drupal](#previewing-a-content-from-drupal)
    - [Developing/debugging queries on a local environment](#developingdebugging-queries-on-a-local-environment)
  - [Data structure](#data-structure)
    - [Store internal structure](#store-internal-structure)
    - [Getting a file](#getting-a-file)
    - [Getting a subset of files](#getting-a-subset-of-files)
      - [Subset options](#subset-options)
      - [Return value](#return-value)
    - [Getting a subset of files via HTTP](#getting-a-subset-of-files-via-http)
  ...
  - [Dependency tags](#dependency-tags)
    - [Dependency tagger](#dependency-tagger)
      - [`setDependency(tag: string, dependsOnTags: string[]): void`](#setdependencytag-string-dependsontags-string-void)
      - [`addDependency(tag: string, dependsOnTags: string[]): void`](#adddependencytag-string-dependsontags-string-void)
      - [`deleteDependency(tag: string, dependsOnTags?: string[]): void`](#deletedependencytag-string-dependsontags-string-void)
      - [`invalidateTags(tags: string[]): void`](#invalidatetagstags-string-void)
    - [Dependency tags example](#dependency-tags-example)
      - [`File taxonomy.hook.js`](#file-taxonomyhookjs-1)
      - [`File listContentsByTermId.query.js`](#file-listcontentsbytermidqueryjs-1)
  - [Run modes](#run-modes)
    - [Dev run mode](#dev-run-mode)
    - [Prod run mode](#prod-run-mode)
