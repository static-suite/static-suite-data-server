...
const fixturesDir = path_1.default.join(__dirname, '../../../../../src/lib/utils/fs/__tests__/fixtures/');
...
describe('File System utils test', () => {
    describe('isJsonFile', () => {
        it('detects a valid JSON filepath', () => {
            expect((0, fsUtils_1.isJsonFile)('valid-file.json')).toBe(true);
        });
        it('detects an invalid JSON filepath', () => {
            expect((0, fsUtils_1.isJsonFile)('invalid-file.txt')).toBe(false);
        });
    });
    describe('readFile', () => {
