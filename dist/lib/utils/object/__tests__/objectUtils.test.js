...
describe('Object utils test', () => {
    ...
    describe('getObjectValue', () => {
        ...
        it('gets object value with default separator', () => {
            expect((0, __1.getObjValue)(testObject, 'x.y.z')).toBe('value');
        });
        ...
        it('gets undefined when path does not exist', () => {
            expect((0, __1.getObjValue)(testObject, 'x.z.z')).toBeUndefined();
        });
    });
    describe('jsonify', () => {
        const testObject = {
        ...
        it('jsonify object containing Set and Map', () => {
            expect((0, objectUtils_1.jsonify)(testObject)).toEqual({
                x: [1, 2],
                y: { mapKey: 'mapValue' },
            });
        });
