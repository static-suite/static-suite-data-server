...
config_1.config.queryDir = (0, path_1.resolve)(path_1.default.join(__dirname, '../__mocks__'));
exports.exampleQueryManager = (0, module_1.dirBasedModuleGroupManager)('query');
