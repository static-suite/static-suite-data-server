...
exports.dataDirManager = {
    ...
    loadDataDir: (options = { useCache: false }) => {
        ...
        if (options.useCache) {
            if (store_1.store.updated) {
                ({ updated: updatedFiles } = workDir_1.workDirHelper.getChangedFilesSince(store_1.store.updated));
            }
    ...
    updateDataDir: () => {
        ...
        if (dataDirLastUpdate && store_1.store.updated) {
            if (dataDirLastUpdate > store_1.store.updated) {
                ...
                const changedFiles = workDir_1.workDirHelper.getChangedFilesSince(storeLastUpdate);
     ...
     */
    getDataDirLastUpdate: () => workDir_1.workDirHelper.getLastUpdate() || store_1.store.updated,
};
